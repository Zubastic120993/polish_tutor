...
try:
    ...
    print(f"   ✅ API working - {len(data['review_phrases'])} review, {len(data['new_phrases'])} new")
except Exception as e:
    print(f"   ❌ API error: {e}")
    sys.exit(1)
...
frontend_component = project_root / "frontend-react/src/components/practice/NewPhrasePractice.tsx"
