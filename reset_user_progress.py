...
from src.models import User, Phrase, SRSMemory, Lesson, LessonProgress, Attempt, Setting, Meta
...
if __name__ == "__main__":
    ...
    parser.add_argument("--keep", type=int, default=0, help="Number of memories to keep (default: 0)")
